...
export class CardapioComponent implements OnInit {
    ...
    escolherLado(indice: number, cardapio: Cardapio): boolean {
        if (indice % 2 == 0 && this.categoriaFiltro == cardapio.categoria || indice % 2 == 0 && this.categoriaFiltro == 'Tudo') {
            return true;
        } else if (indice % 2 != 0 && this.categoriaFiltro == cardapio.categoria || indice % 2 != 0 && this.categoriaFiltro == 'Tudo') {
            return false;
        }
    }
