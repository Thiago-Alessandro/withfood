...
export class CardapioComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.clienteLogado = this.localStorageService.getClienteLogado();
        if (this.clienteLogado.cpf) {
            this.usuarioLogadoCliente = true 
            //cpa n precisa disso agr pq a funcao tipada teoricamente obriga a ser um cliente
        }
    }
